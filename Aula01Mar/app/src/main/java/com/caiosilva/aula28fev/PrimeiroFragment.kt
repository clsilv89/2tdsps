...
class PrimeiroFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        dialog.setMessage("Mostrou a mensagem!!!")
        dialog.setPositiveButton(param1, object : DialogInterface.OnClickListener {
            override fun onClick(dialog: DialogInterface?, which: Int) {
                Toast.makeText(requireContext(), param1, Toast.LENGTH_SHORT).show()
            }
        })
        dialog.setNegativeButton(param2, object : DialogInterface.OnClickListener {
            override fun onClick(dialog: DialogInterface?, which: Int) {
